...
async function encrypt(plTxt, keyin=NAMASTE_ENCDECALG.defaultKey, ioEncoding="ByteArray") {
    ...
    return LZUTF8.compress(result, { outputEncoding: ioEncoding })
}
